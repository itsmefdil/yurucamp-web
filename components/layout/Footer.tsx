                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li><Link href="/" className="hover:text-orange-500 transition-colors flex items-center gap-2">Beranda</Link></li>
                            <li><Link href="/activity" className="hover:text-orange-500 transition-colors flex items-center gap-2">Activity</Link></li>
                            <li><Link href="/camp-area" className="hover:text-orange-500 transition-colors flex items-center gap-2">Camp Area</Link></li>
                            <li><Link href="/event" className="hover:text-orange-500 transition-colors flex items-center gap-2">Acara</Link></li>
                            <li><Link href="/watch" className="hover:text-orange-500 transition-colors flex items-center gap-2">Nonton</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li><Link href="/tentang" className="hover:text-orange-500 transition-colors">Yuru Camp Fans</Link></li>
