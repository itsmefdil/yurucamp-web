...
import { ArrowLeft, Image as ImageIcon, MapPin, X, Plus, Calendar, Clock, Users, Ticket } from "lucide-react"
    ...
    return (
        <div className="max-w-xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-black text-gray-800">Buat Acara Baru</h1>
            </div>
            ...
            <Card className="border-none shadow-lg bg-white overflow-hidden">
                <CardContent className="p-8 space-y-6">
                        ...
                        <div className="relative aspect-video rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 flex flex-col items-center justify-center overflow-hidden hover:bg-gray-100 transition-colors group">
                            {selectedImage ? (
                                ...
                                <label htmlFor="image-upload" className="cursor-pointer w-full h-full flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-sm font-medium text-gray-500">Klik untuk upload banner</p>
                                    <input
                                        id="image-upload"
                                        type="file"
                                        accept="image/*"
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="title"
                            placeholder="Contoh: Gathering Nasional 2024"
                    ...
                    <div className="space-y-2">
                        ...
                        <Select>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="social">Bakti Sosial</SelectItem>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            className="rounded-xl bg-gray-50 border-gray-200 min-h-[150px] resize-none"
                        />
                    </div>
