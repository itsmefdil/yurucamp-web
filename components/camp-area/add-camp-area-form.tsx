                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <label className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-primary/50 transition-all cursor-pointer group">
                            <Checkbox name="wifi" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                        ...
                        <label className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-primary/50 transition-all cursor-pointer group">
                            <Checkbox name="parking" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                            <div className="flex items-center gap-2">
                        ...
                        <label className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-primary/50 transition-all cursor-pointer group">
                            <Checkbox name="canteen" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                            <div className="flex items-center gap-2">
                        ...
                        <label className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-primary/50 transition-all cursor-pointer group">
                            <Checkbox name="tent" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                            <div className="flex items-center gap-2">
                        ...
                        <label className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-primary/50 transition-all cursor-pointer group">
                            <Checkbox name="info" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                            <div className="flex items-center gap-2">
