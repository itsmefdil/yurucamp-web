...
import type { User, Activity, CampArea, Event } from '../../types';
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 p-8 bg-white rounded-3xl shadow-lg border border-gray-100">
                <div className="relative">
                    ...
                    <Button size="icon" className="absolute bottom-0 right-0 rounded-full shadow-md h-10 w-10 border-2 border-white" asChild>
                        <Link to="/dashboard/pengaturan/edit-profil">
                ...
                <div className="flex-1 text-center md:text-left space-y-2">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-2 pt-2">
                        ...
                        <span className="bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-xs font-bold">Member sejak {new Date(profile?.createdAt || Date.now()).getFullYear()}</span>
                    </div>
                </div>
                            ...
                            {campAreas.length === 0 ? (
                                <div className="text-center py-12 bg-white rounded-xl border border-dashed border-gray-300">
                                    ...
                                    <Button variant="outline" className="rounded-full" asChild>
                                        <Link to="/dashboard/add-camp-area">Tambah Camp Area Baru</Link>
                                    </Button>
                                </div>
                            ) : (
                                                ...
                                                <div className="flex-1 p-6 flex flex-col justify-between">
                                                    ...
                                                    <div className="flex gap-3">
                                                        <Button size="sm" variant="outline" className="rounded-full" asChild>
                                                            <Link to={`/camp-areas/${camp.id}`}>Lihat</Link>
                                                        </Button>
                                                        <Button size="sm" className="rounded-full gap-2" asChild>
                                                            <Link to={`/dashboard/edit-camp-area/${camp.id}`}>
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <div className="flex items-center gap-4 text-sm text-gray-600 mb-2">
                                                            <span className="flex items-center gap-1">
                                                                <Calendar className="h-4 w-4" /> {activity.createdAt ? new Date(activity.createdAt).toLocaleDateString() : 'No Date'}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div className="flex gap-3">
                    ...
                    {activeTab === "events" && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="text-center py-12 bg-white rounded-xl border border-dashed border-gray-300">
                                ...
                                <Button variant="outline" className="rounded-full" asChild>
                                    <Link to="/events">Cari Acara Seru</Link>
                                </Button>
                            </div>
                        </div>
                    )}
